...
| 8.6b, d〜e | 製品化基盤 (キーバインド/自動保存/基本編集の穴埋め) | ⏭️ P1 (**次にやること**、WI-10=キーバインド設定から) |
| **12'** | **MVP 出荷判定** | ⏭️ 新設 |
