...
| 8.6b〜e | 製品化基盤 (キーバインド/テーマ/自動保存/基本編集の穴埋め) | ⏭️ P1 (**次にやること**、WI-09=テーマから) |
| **12'** | **MVP 出荷判定** | ⏭️ 新設 |
