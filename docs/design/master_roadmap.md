...
| 11 | Git / LSP / マクロ (Lua + JS + 秀丸互換レイヤ) | **着手 (WI-17a〜b完了、2026-08-22): Git統合はヘッドレス基盤+非同期化+EditorSession配線(`neomifes::git`、`GitDiffWorker`)まで実装済み。UI(左ガター/Gitペイン/Diffビュー/Blame/Commit/Branch切替)/LSP/マクロは未着手** | §11 |
