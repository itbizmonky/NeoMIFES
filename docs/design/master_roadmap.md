...
| 6d〜 | Document/OriginalBuffer統合・10GB mmap一般化 | ⏭️ 次候補 | §6 |
...
**Phase 6全体の残りはPhase 6d(Document/OriginalBuffer統合、10GB mmap一般化)のみ。Phase 5c5(検索履歴永続化)はこのセッション冒頭で「Phase 6優先」の承認を得ており、Phase 6完了までは次フェーズ候補として並記しない方針を明確化した。**
