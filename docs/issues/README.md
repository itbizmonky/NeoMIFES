...
| [`handleSysKeyDownEvent()`にDiffビューガードが無い](handle_sys_key_down_missing_diff_view_guard.md) | Diffビュー表示中でもShift+Alt+矢印/Iが不可視の実文書へ適用されてしまう。WI-27のPlan agentレビューで副次的に発見 | 待機 (次点候補) |
